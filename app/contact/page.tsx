...
export const metadata = {
  ...
  description: 'Get in touch with the StayScape team. We\'re here to help with any questions about vacation rentals.',
}
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-400 text-sm">tony@cosmicjs.com</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="font-semibold text-gray-600 mb-2">Response Time</h3>
